...
Contact.create([
  { :name => "Vintaer Bernard", :email => "bernard.vintaer@sfr.fr", :position => "Président", :created_at => "2013-05-09 08:17:54", :updated_at => "2013-05-09 08:17:54", :phone => "05 53 58 27 05" },
  { :name => "Karsenti Jean-Paul", :email => "jplil4549@yahoo.fr", :position => "Secrétaire", :created_at => "2013-05-09 08:17:54", :updated_at => "2013-05-09 08:17:54", :phone => nil },
  { :name => "Licour Michel", :email => "michel.licour@free.fr", :position => "Trésorier", :created_at => "2013-05-09 08:17:54", :updated_at => "2013-05-09 08:17:54", :phone => nil }
...
Event.create([
  ...
  { :title => "Quine", :begin_at => "2013-03-16", :end_at => nil, :place => "salle des fêtes de PRIGONRIEUX", :description => "", :album_title => "quine-2013", :created_at => "2013-05-09 08:17:54", :updated_at => "2013-05-09 08:17:54" },
...
User.create([
  { :email => "admin@garsdunordbergerac.org", :password => "password", :password_confirmation => 'password' }
], :without_protection => true )
